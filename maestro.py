...
class Controller:
    ...
    def __init__(self,port=0):
        ...
        self.PololuCmd = (0xaa).to_bytes(1,byteorder='big') + (0xc).to_bytes(1,byteorder='big')
    ...
    def setTarget(self, chan, target):
        ...
        cmd =self.PololuCmd + (0x04).to_bytes(1,byteorder='big')+ chan.to_bytes(1,byteorder='big') + lsb.to_bytes(1,byteorder='big') + msb.to_bytes(1,byteorder='big')
        self.usb.write(cmd)
        # Record Target value
    ...
    def setSpeed(self, chan, speed):
        ...
        self.usb.write(bytearray(cmd,'437'))
